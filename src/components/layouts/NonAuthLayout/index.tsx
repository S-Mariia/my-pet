      ...
      <MainWrapper>
        <div className="h-full mid:flex-row flex-col flex items-center justify-between ">
          <div className=" mid:h-full h-[400px] min-h-[400px] mid:w-[50%] sm:w-[80%] w-full flex flex-col justify-between">
            <div
                className="h-[66px] w-[84px] max-h-[66px] max-w-[84px] mid:h-[94px] mid:w-[120px] mid:max-h-[94px] mid:max-w-[120px]">
              <Image src={logo} alt="Pow buddy" width={120} height={94}
                     className="w-full h-full object-cover"/></div>
            <div
              className="mt-[-150px] mid:mt-[auto]  w-full h-full mid:h-[70%]  relative bg-[url(/images/auth/dog.png)] bg-no-repeat bg-contain bg-bottom mid:mb-[-40px]"
            />
          </div>
