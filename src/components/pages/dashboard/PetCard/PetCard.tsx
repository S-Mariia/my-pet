...
function PetCard({pet}: PetCardProps) {
    ...
    return (
        <div className='transition duration-300 ease-in-out hover:scale-[1.03] cursor-pointer xl:w-[25%] lg:w-[33%] w-[50%]' key={pet.petId} onClick={()=>router.push(`/pets-list/${pet.petId}`)}>
            <div
                ...
                <div
                    className="relative bg-light-bg-md dark:bg-dark-gray-bg rounded-full lg:w-[80%] w-[90%] p-[15px] shadow aspect-square">
