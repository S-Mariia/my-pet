...
import {
  defaultValues,
  schema,
} from "@/components/modals/AddEventModal/schema/addHealth";
import CustomButton from "@/components/common/CustomButton/CustomButton";
import Calendar from "@/components/common/Calendar/Calendar";
import Textarea from "@/components/common/Textarea/Textarea";
import { HealthEvent } from "@/types/petData";
import {
  nutritionDefaultValues,
  nutritionSchema,
} from "@/components/modals/AddEventModal/schema/nutrition";
...
const AddEventModal: React.FC<AddEventModalProps> = ({
  ...
  const currentDefaultValues =
    type === "nutrition" ? nutritionDefaultValues : defaultValues;
